...
.девон_карта .титр{position:absolute;left:18px;bottom:18px;right:18px;padding:10px 14px;border-radius:12px;background:rgba(5,8,16,.86);border-left:4px solid var(--мята);font-size:18px;font-weight:600;color:var(--текст)}
  ...
  <div class="полотно">
    ...
    <div class="живая_сетка девон">
      ...
      <div class="девон_карта">
        ...
        <div class="титр"><span>Структурная поверхность девона (D3)</span><small>карта миграции УВ: глубины от −4 000 до −14 000 м, контуры участков и месторождения</small></div>
      </div>
    </div>
  </div>
</section>
...
for пр in портфель['проекты']:
    if пр['класс'] == 'жылыой':
        проекты.append(dict(пр, имя='Жылыой', класс='жылыой'))
...
ПОРЯДОК_КЛАССОВ.append('жылыой'); КЛАСС_ИМЯ['жылыой'] = 'Жылыойская платформа · глубокие перспективы Прикаспия'; КЛАСС_ЦСС['жылыой'] = 'жыл'
