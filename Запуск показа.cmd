...
rem
rem  Зачем отдельный запуск, а не двойной щелчок по сцена_v2.html.
rem
...
rem  17.09 (Адиль): стенд идёт через процессы (сцена_v2), веер систем — сцена.html
set "ПОКАЗ=%~dp0сцена_v2.html"
